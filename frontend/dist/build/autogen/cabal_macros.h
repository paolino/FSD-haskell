...
/* package reflex-dom-0.3 */
#define VERSION_reflex_dom "0.3"
#define MIN_VERSION_reflex_dom(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 0)

/* package servant-reflex-0.1 */
#define VERSION_servant_reflex "0.1"
...
#define CURRENT_PACKAGE_KEY "front_9kSPJ5h0EIeHUSUxw6Fsec"
